  ...
  const emptyState = (
    ...
    >
      <Space>
        ...
        <Button icon={<NodeIndexOutlined />} onClick={() => navigate('/hermes/relationships/graph')}>
          使用关系图谱
        </Button>
      </Space>
    </Empty>
    ...
    <div className={styles.container}>
      <Card>
        <div className={styles.header}>
          ...
          <Space>
            <Button icon={<NodeIndexOutlined />} onClick={() => navigate('/hermes/relationships/graph')}>关系图谱</Button>
