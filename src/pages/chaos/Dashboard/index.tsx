    ...
    <div className={styles.container}>
      ...
      <Row gutter={[24, 24]}>
        <Col xs={24} sm={12} lg={6}>
          <Card hoverable className={styles.statCard} onClick={() => navigate('/chaos/templates')}>
            <Statistic
              title="邮件模板"
              value={templateCount}
        ...
        <Col xs={24} sm={12} lg={6}>
          <Card hoverable className={styles.statCard} onClick={() => navigate('/chaos/files')}>
            <Statistic
              title="文件上传"
              value="上传"
